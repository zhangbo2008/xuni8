...
args.img_size = 96
args.checkpoint_path = 'tmp2/checkpoint.pth' # 自己训练的



# args.checkpoint_path = '/kaggle/working/Wav2Lip/'+'checkpoints/wav2lip_gan.pth' #原始的.
args.face = 'examples/source_image/full4.jpeg'
args.face = 'examples\ref_video\WDA_KatieHill_000.mp4'
args.audio = 'examples/driven_audio/itosinger1.wav'


args.face='section_1_024.07_026.30.mp4'

args.audio = 'section_1_024.07_026.30.wav'
